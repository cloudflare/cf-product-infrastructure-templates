...
locals {
  ...
  cds_scanner_ecr                    = "590183649595.dkr.ecr.${data.aws_region.current.name}.amazonaws.com/cde/scanner:v1.0.0-arm64"
  cds_crawler_ecr                    = "590183649595.dkr.ecr.${data.aws_region.current.name}.amazonaws.com/cde/crawler:v1.0.0-arm64"
  cds_control_ecr                    = "590183649595.dkr.ecr.${data.aws_region.current.name}.amazonaws.com/cde/control:v1.0.0-arm64"
